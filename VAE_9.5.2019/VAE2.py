...
for epoch in range(max_epochs):
    ...
    show_and_save('Input_epoch_%d.png' % epoch ,make_grid((fixed_batch.data).cpu(),8))
    ...
    show_and_save('Error_epoch_%d.png' % epoch ,make_grid((fixed_batch.data-rec_imgs.data).cpu(),8))
