...
#rec_img_org=pywt.waverec2(c, 'db2', mode='periodization',axes=(1, 2))
arr, slices = pywt.coeffs_to_array(c,axes=(1, 2))
#rec_img_org=pywt.array_to_coeffs(arr,slices)
...
X_train, X_valid = train_test_split(arr_final, test_size=0.1, random_state=10002,shuffle=False)
#fig, ax = plt.subplots()
...
for epoch in range(max_epochs):
    ...
    rec_img_org=pywt.array_to_coeffs(rec_img_org,slices,output_format='wavedec2')
    rec_img_org=pywt.waverec2(rec_img_org, 'db2', mode='periodization',axes=(1, 2))
    ...
    fixed_batch_img_org=pywt.array_to_coeffs(fixed_batch_img_org,slices,output_format='wavedec2')
