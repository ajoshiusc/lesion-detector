...
def auto_encoder(input_size,loss1,alpha):
    ...
    Conv1 = Conv2D(16, (4, 3), activation='relu', padding='same')(input_img)
    ...
    decoded = Conv2D(3, (3, 3,), activation='sigmoid', padding='same')(Conv12)
    if loss1=='SV':
