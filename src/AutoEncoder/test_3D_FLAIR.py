...
im_size=64
model=load_model('/big_disk/akrami/git_repos/lesion-detector/src/AutoEncoder/models/tp_model_200_512_merryland_30_MSEF2_TV_0.9.h5',custom_objects={'TV_R': TV_reconstructed_loss(alpha)})
...
img.to_filename('/big_disk/akrami/MSE_TBI62_MSEF_TV_0.9.nii.gz')


img = ni.new_img_like(t1model, out_vol[:,:,:,0])
img.to_filename('/big_disk/akrami/outFLAIR_TBI62_MSEF_TV_0.9.nii.gz')



img = ni.new_img_like(t1model, vol_data[:,:,:,2]-out_vol[:,:,:,0])
img.to_filename('/big_disk/akrami/difFLAIR_TBI62_MSEF_TV_0.9.nii.gz')
